  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      ...
      <ul class="navbar-nav ms-auto nav-tabs">
        <li class="nav-item">
          <a class="nav-link <?php if($current_page=='rcd_dashboard.php') echo 'active'; ?>" href="rcd_dashboard.php">
            <span class="material-icons">home</span> Dashboard
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($current_page=='rcd_index.php') echo 'active'; ?>" href="rcd_index.php">
            <span class="material-icons">add</span> New
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php if($current_page=='rcd_cash.php') echo 'active'; ?>" href="rcd_cash.php">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if($current_page=='archived_records.php') echo 'active'; ?>" href="rcd_archieved.php">
